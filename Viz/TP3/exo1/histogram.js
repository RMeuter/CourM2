...
function updateHistX(att){
	...
	.attr("height", function(d) {console.log(dataHist); return hHist-50-scaleYHist(d[attHist].density); })
	.attr("y", function(d) { return 25+scaleYHist(d[attHist].density); });
	
	gxAxisHist.call(xAxisHist);
}
